...
const Contact = () => {
  ...
  return (
    <section id="contact" className="mt-25 flex items-center">
      <div class="absolute top-0 -z-10 h-full w-full"><div class="absolute bottom-auto left-auto right-0 top-0 h-[600px] w-[600px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[#bb4d00] opacity-25 blur-[80px]"></div></div>
